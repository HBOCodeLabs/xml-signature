...
function ExclusiveCanonicalization(options) {
...
ExclusiveCanonicalization.prototype.process = function(node) {
  ...
  var res = this.processInner(node, [], "", this.inclusiveNsList);
...
ExclusiveCanonicalization.prototype.getTransformDescriptionXml = function() {
  return  '<Transform Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#">' +
          '<ec:InclusiveNamespaces xmlns:ec="http://www.w3.org/2001/10/xml-exc-c14n#" PrefixList="' +
          this.inclusiveNsList.join(' ') +
          '" />' +
          '</Transform>';
};
...
ExclusiveCanonicalizationWithComments.prototype.getTransformDescriptionXml = function() {
  return  '<Transform Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#WithComments">' +
          '<ec:InclusiveNamespaces xmlns:ec="http://www.w3.org/2001/10/xml-exc-c14n#" PrefixList="' +
          this.inclusiveNsList.join(' ') +
          '" />' +
          '</Transform>';
